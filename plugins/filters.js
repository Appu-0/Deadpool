...
const array = ['Msd','Vijay','Rashmika','song','Sry','Line','aara','bye','Da','dj','gd mrng','gd n8','Hi','Hlo','kalipp','kazhicho','kollaam','Mathu','modeesh','Muthe','myr','omg','pever','poda','nee poovaa','saved','sed','Smile','sugano','Thyr','wow','vivek pro',]
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
